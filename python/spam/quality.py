...
def compute_quality_for_corpus(corpus_dir):
    results = {'truth': utils.read_classification_from_file(corpus_dir + "/" + "!truth.txt"),
    ...
    return quality_score(matrix_for_quality['tp'], matrix_for_quality['tn'], matrix_for_quality['fp'],
                         matrix_for_quality['fn'])
